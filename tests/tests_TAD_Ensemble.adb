...
package body tests_TAD_Ensemble is
   ...
   -- test de plus grand
   function test_Ensemble_P9 return Boolean is
      e : Type_Ensemble;
      x : Integer;
   begin
      x := 4;
      ...
      return plusGrand(x,e);
      end test_Ensemble_P9;
   -- test plusgrandquecase
   function test_Ensemble_P10 return Boolean is
      e : Type_Ensemble;
      x : Integer;
   begin
      x := 4;
      ...
      return plusGrandQueCase(x,e) = 5;
      end test_Ensemble_P10;
