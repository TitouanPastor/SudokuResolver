...
package tests_TAD_Ensemble is
   ...
   function test_Ensemble_P9 return Boolean;
   function test_Ensemble_P10 return Boolean;
     ...
     ((test_Ensemble_P1'Access,
      ...
      (test_Ensemble_Exception2'Access,
       To_Unbounded_String ("echec de la l'exception 2 Ensemble")),
           (test_Ensemble_P9'Access,
       To_Unbounded_String ("echec de la propriete 9 Ensemble")),
           (test_Ensemble_P10'Access,
       To_Unbounded_String ("echec de la propriete 10 Ensemble")));
