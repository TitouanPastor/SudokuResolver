...
package tests_TAD_Coordonnee is
   ...
   function test_Coordonnees_P5a return Boolean;
   function test_Coordonnees_P5b return Boolean;
   ...
   les_Tests : constant array (Positive range <>) of Test_Unitaire :=
     ((test_Coordonnees_P1'Access,
      ...
      (test_Coordonnees_P5a'Access,
       To_Unbounded_String ("echec de la propriete 5a Coordonnees")),
      (test_Coordonnees_P5b'Access,
       To_Unbounded_String ("echec de la propriete 5b Coordonnees")));
